...
import { createUpstreamState, getMicrosoftProvider } from '@/services/idp';
...
export async function GET(req: NextRequest) {
  ...
  if (!discovery || !discovery.authorization_endpoint) {
    return html('<h1>Microsoft sign-in failed</h1><p>Could not discover OIDC endpoints for the configured authority.</p>', 400);
  }
